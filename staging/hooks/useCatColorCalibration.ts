...
import { extractHsvKmeans } from "@/../staging/lib/cat-identity/extractors/hsvKmeansExtractor";
import { detectLighting } from "@/../staging/lib/cat-identity/extractors/lightingDetector";
import { buildProfileV1 } from "@/../staging/lib/cat-identity/calibration/profileBuilder";
import type { HsvSample, LightingLevel } from "@/../staging/lib/cat-identity/types";
